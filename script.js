...
const FLAVORS = [
  {
    ...
    accentBg: '#fff0ef',
    price: 24.90,
    description: 'A doçura do morango fresco encontra o toque cítrico do limão siciliano. Refrescante e irresistível — perfeito para o café da manhã.',
    tags: ['Mais vendido', 'Refrescante'],
  },
  {
    id: 'manga-maracuja',
    ...
    accentBg: '#fff8ed',
    price: 26.90,
    description: 'A cremosidade da manga Haden com o perfume tropical do maracujá. Um sabor que transporta para o verão o ano todo.',
    tags: ['Tropical', 'Especial'],
  },
  {
    id: 'abacaxi-gengibre',
    ...
    accentBg: '#f0fff6',
    price: 25.90,
    description: 'A acidez doce do abacaxi com o calor sutil do gengibre fresco. Uma combinação sofisticada e cheia de personalidade.',
    tags: ['Picante suave', 'Exclusivo'],
  },
];
      ...
      <div class="section-container">
        <div class="section-header">
          ...
          <p class="flavors__subtitle">
            Cada geleia é produzida em pequenos lotes com frutas frescas selecionadas.
